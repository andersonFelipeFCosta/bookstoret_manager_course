...
import br.com.affc.bookstoremanager.utils.BookUtils;
...
import static br.com.affc.bookstoremanager.utils.BookUtils.*;
...
public class BookControllerTest {
    ...
    public static final String BOOK_API_URL_PATH = "/app/v1/books";
    ...
    void setUp(){
        mockMvc = MockMvcBuilders.standaloneSetup(bookController)
                ...
                .setViewResolvers((viewName,lacale) -> new MappingJackson2JsonView())
                .build();
    }

    @Test
    void testWhenPostisCalledABookShlouldBeCreated() throws Exception {
